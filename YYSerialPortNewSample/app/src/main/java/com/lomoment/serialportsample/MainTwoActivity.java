...
import com.lomoment.serialportsample.slavecomputer.SlaveComputerManager;
...
public class MainTwoActivity extends AppCompatActivity implements SlaveComputerManager.DeliverDiSposeListener {

    private EditText etx;
    private EditText ety;
    private TextView tvContent;

    private SlaveComputerManager singleChipManager;
    ...
    private void createSerialPortObj() {
        ...
        singleChipManager = SlaveComputerManager.getInstance();
